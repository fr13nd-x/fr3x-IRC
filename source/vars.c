...
{
	{ "AINV",0,			INT_TYPE_VAR,	DEFAULT_AINV, NULL, NULL, 0, VIF_fr3X },
	{ "ALTNICK",0,			STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "ALT_CHARSET", 0,		BOOL_TYPE_VAR,	DEFAULT_ALT_CHARSET, NULL, NULL, 0, VIF_fr3X },
	{ "ALWAYS_SPLIT_BIGGEST",0,	BOOL_TYPE_VAR,	DEFAULT_ALWAYS_SPLIT_BIGGEST, NULL, NULL, 0, 0 },
	{ "ANNOY_KICK",0,		BOOL_TYPE_VAR,	DEFAULT_ANNOY_KICK, NULL, NULL, 0, VIF_fr3X },
	{ "AOP",0,			BOOL_TYPE_VAR,	DEFAULT_AOP_VAR, NULL, NULL, 0, VIF_fr3X  },
	{ "APPEND_LOG",0,		BOOL_TYPE_VAR,	1, NULL, NULL, 0, VIF_fr3X }, 
	
	{ "AUTOKICK_ON_VERSION",0,	BOOL_TYPE_VAR,  0, NULL, NULL, 0, VIF_fr3X },
	{ "AUTO_AWAY",0,		BOOL_TYPE_VAR,  DEFAULT_AUTO_AWAY, NULL, NULL, 0, VIF_fr3X },
	{ "AUTO_AWAY_TIME",0,		INT_TYPE_VAR,	DEFAULT_AUTO_AWAY_TIME, NULL, set_away_time, 0, VIF_fr3X  },
	{ "AUTO_JOIN_ON_INVITE",0,	BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "AUTO_LIMIT",0,		INT_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "AUTO_NSLOOKUP",0,		BOOL_TYPE_VAR,  DEFAULT_AUTO_NSLOOKUP, NULL, NULL, 0, VIF_fr3X  },
	{ "AUTO_RECONNECT",0,		BOOL_TYPE_VAR,	DEFAULT_AUTO_RECONNECT, NULL, NULL, 0, VIF_fr3X },
	{ "AUTO_REJOIN",0,		INT_TYPE_VAR,   DEFAULT_AUTO_REJOIN, NULL, NULL, 0, VIF_fr3X  },
	{ "AUTO_RESPONSE",0,		BOOL_TYPE_VAR,	1, NULL, NULL, 0, VIF_fr3X },
	{ "AUTO_RESPONSE_STR",0,	STR_TYPE_VAR,	0, NULL, reinit_autoresponse, 0, VIF_fr3X },
	{ "AUTO_UNBAN",0,		INT_TYPE_VAR,	DEFAULT_AUTO_UNBAN, NULL, NULL, 0, VIF_fr3X },
	...
	{ "BANTIME", 0, 		INT_TYPE_VAR,	DEFAULT_BANTIME, NULL, NULL, 0, VIF_fr3X }, 
	{ "BEEP",0,			BOOL_TYPE_VAR,	DEFAULT_BEEP, NULL, NULL, 0, VIF_fr3X },
	{ "BEEP_ALWAYS",0,		BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "BEEP_MAX",0,			INT_TYPE_VAR,	DEFAULT_BEEP_MAX, NULL, NULL, 0, 0 },
	{ "BEEP_ON_MSG",0,		STR_TYPE_VAR,	0, NULL, set_beep_on_msg, 0, VIF_fr3X },
	{ "BEEP_WHEN_AWAY",0,		INT_TYPE_VAR,	DEFAULT_BEEP_WHEN_AWAY, NULL, NULL, 0, VIF_fr3X },
	{ "fr3",0,			BOOL_TYPE_VAR,  0, NULL, NULL, 0, VIF_fr3X },
	{ "fr3X_HELP",0,		STR_TYPE_VAR,   0, NULL, NULL, 0, VIF_fr3X },
	{ "BLINK_VIDEO",0,		BOOL_TYPE_VAR,	DEFAULT_BLINK_VIDEO, NULL, NULL, 0, 0 },
	{ "BOLD_VIDEO",0,		BOOL_TYPE_VAR,	DEFAULT_BOLD_VIDEO, NULL, NULL, 0, 0 },
	{ "BOT_LOG",0,			BOOL_TYPE_VAR,	1, NULL, NULL, 0, VIF_fr3X  },
	{ "BOT_LOGFILE",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X  },
	...
	{ "CDCC_FLOOD_AFTER",0,		INT_TYPE_VAR,	DEFAULT_CDCC_FLOOD_AFTER, NULL, NULL, 0, VIF_fr3X  },
	{ "CDCC_FLOOD_RATE",0,		INT_TYPE_VAR,	DEFAULT_CDCC_FLOOD_RATE,NULL, NULL, 0, VIF_fr3X  },
	{ "CDCC_PROMPT",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "CDCC_SECURITY",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X  },
#ifdef WANT_CD
	{ "CD_DEVICE",0,		STR_TYPE_VAR,	0, NULL, set_cd_device, 0, VIF_fr3X },
#else
	{ "CD_DEVICE",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
#endif
	{ "CHANGE_NICK_ON_KILL",0,	BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "CHANMODE",0,			STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	...
	{ "CLOAK",0,			INT_TYPE_VAR,	DEFAULT_CLOAK, NULL, BX_update_all_status, 0, VIF_fr3X },
	{ "CLOCK",0,			BOOL_TYPE_VAR,	DEFAULT_CLOCK, NULL, BX_update_all_status, 0, 0 },
	{ "CLOCK_24HOUR",0,		BOOL_TYPE_VAR,	DEFAULT_CLOCK_24HOUR, NULL, reset_clock, 0, VIF_fr3X },
	...
	{ "CONNECT_DELAY",0,		INT_TYPE_VAR,	DEFAULT_CONNECT_DELAY, NULL, NULL, 0, VIF_fr3X },
	...
	{ "CPU_SAVER_AFTER",0,		INT_TYPE_VAR,	DEFAULT_CPU_SAVER_AFTER, NULL, NULL, 0, VIF_fr3X },
	{ "CPU_SAVER_EVERY",0,		INT_TYPE_VAR,	DEFAULT_CPU_SAVER_EVERY, NULL, NULL, 0, VIF_fr3X },
	{ "CTCP_DELAY",0,		INT_TYPE_VAR,	DEFAULT_CTCP_DELAY, NULL, NULL, 0, VIF_fr3X },
	{ "CTCP_FLOOD_AFTER",0,		INT_TYPE_VAR,	DEFAULT_CTCP_FLOOD_AFTER, NULL, NULL, 0, VIF_fr3X },
	...
	{ "CTCP_FLOOD_RATE",0,		INT_TYPE_VAR,	DEFAULT_CTCP_FLOOD_RATE, NULL, NULL, 0, VIF_fr3X},
	{ "CTCP_VERBOSE",0,		BOOL_TYPE_VAR,	DEFAULT_VERBOSE_CTCP, NULL, NULL, 0, 0 },
	{ "CTOOLZ_DIR",0,		STR_TYPE_VAR,   0, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_AUTOGET",0,		BOOL_TYPE_VAR,	DEFAULT_DCC_AUTOGET, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_AUTORENAME",0,		BOOL_TYPE_VAR,	DEFAULT_DCC_AUTORENAME, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_AUTORESUME",0,		BOOL_TYPE_VAR,	DEFAULT_DCC_AUTORESUME, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_BAR_TYPE",0,		INT_TYPE_VAR,	DEFAULT_DCC_BAR_TYPE, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_BLOCK_SIZE",0,		INT_TYPE_VAR,	DEFAULT_DCC_BLOCK_SIZE, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_DLDIR",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_FAST",0,			BOOL_TYPE_VAR,	DEFAULT_DCC_FAST, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_FORCE_PORT",0,		INT_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_GET_LIMIT",0,		INT_TYPE_VAR,	DEFAULT_DCC_GET_LIMIT, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_MAX_AUTOGET_SIZE",0,	INT_TYPE_VAR,	DEFAULT_MAX_AUTOGET_SIZE, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_QUEUE_LIMIT",0,		INT_TYPE_VAR,	DEFAULT_DCC_QUEUE_LIMIT, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_SEND_LIMIT",0,		INT_TYPE_VAR,	DEFAULT_DCC_SEND_LIMIT, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_TIMEOUT",0,		INT_TYPE_VAR,	DEFAULT_DCCTIMEOUT, NULL, set_dcc_timeout, 0, VIF_fr3X },
	{ "DCC_ULDIR",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DCC_USE_GATEWAY_ADDR",0,	BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DEBUG",0,			STR_TYPE_VAR,	0, NULL, debug_window, 0, 0 },
#if defined(__EMXPM__) || defined(WIN32)
	{ "DEFAULT_CODEPAGE",0,		INT_TYPE_VAR,	DEFAULT_CODEPAGE, NULL, NULL, 0, VIF_fr3X },
#endif
	{ "DEFAULT_FONT",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DEFAULT_MENU",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, 0 },
	{ "DEFAULT_NICK",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DEFAULT_REASON",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "DEOPFLOOD",0,		BOOL_TYPE_VAR,	DEFAULT_DEOPFLOOD, NULL, NULL, 0, VIF_fr3X },
	...
	{ "DISPLAY_PC_CHARACTERS",0,	INT_TYPE_VAR,	DEFAULT_DISPLAY_PC_CHARACTERS, NULL, reinit_screen, 0, VIF_fr3X },
	{ "DOUBLE_STATUS_LINE",0,	INT_TYPE_VAR,	DEFAULT_DOUBLE_STATUS_LINE, NULL, reinit_status, 0, VIF_fr3X },
	{ "EIGHT_BIT_CHARACTERS",0,	BOOL_TYPE_VAR,	DEFAULT_EIGHT_BIT_CHARACTERS, NULL, eight_bit_characters, 0, VIF_fr3X },
	...
	{ "FLOOD_AFTER",0,		INT_TYPE_VAR,	DEFAULT_FLOOD_AFTER, NULL, NULL, 0, VIF_fr3X },
	{ "FLOOD_KICK",0,		BOOL_TYPE_VAR,	DEFAULT_FLOOD_KICK, NULL, NULL, 0, VIF_fr3X },
	{ "FLOOD_PROTECTION",0,		BOOL_TYPE_VAR,	DEFAULT_FLOOD_PROTECTION, NULL, NULL, 0, VIF_fr3X },
	{ "FLOOD_RATE",0,		INT_TYPE_VAR,	DEFAULT_FLOOD_RATE, NULL, NULL, 0, VIF_fr3X },
	{ "FLOOD_USERS",0,		INT_TYPE_VAR,	DEFAULT_FLOOD_USERS, NULL, NULL, 0, VIF_fr3X },
	{ "FLOOD_WARNING",0,		BOOL_TYPE_VAR,	DEFAULT_FLOOD_WARNING, NULL, NULL, 0, VIF_fr3X },

	{ "FTP_GRAB",0,			BOOL_TYPE_VAR,	DEFAULT_FTP_GRAB, NULL, NULL, 0, VIF_fr3X },
	{ "FULL_STATUS_LINE",0,		BOOL_TYPE_VAR,	DEFAULT_FULL_STATUS_LINE, NULL, BX_update_all_status, 0, 0 },
	{ "HACKING",0,			INT_TYPE_VAR,	DEFAULT_HACKING, NULL, NULL, 0, VIF_fr3X },
	{ "HACK_OPS",0,			BOOL_TYPE_VAR,	0, NULL, NULL, 0, 0},
	{ "HEBREW_TOGGLE",0,		BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	...
	{ "HTTP_GRAB",0,		BOOL_TYPE_VAR,  DEFAULT_HTTP_GRAB, NULL, NULL, 0, VIF_fr3X }, 
	{ "IDENT_HACK",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "IDLE_CHECK",0,		INT_TYPE_VAR,	120, NULL, NULL, 0, VIF_fr3X },
	{ "IGNORE_TIME",0,		INT_TYPE_VAR,	DEFAULT_IGNORE_TIME, NULL, NULL, 0, VIF_fr3X },
	{ "INDENT",0,			BOOL_TYPE_VAR,	DEFAULT_INDENT, NULL, NULL, 0, 0 },
	{ "INPUT_ALIASES",0,		BOOL_TYPE_VAR,	DEFAULT_INPUT_ALIASES, NULL, NULL, 0, 0 },
	{ "INPUT_GLOB",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	...
	{ "JOINFLOOD",0,		BOOL_TYPE_VAR,	DEFAULT_JOINFLOOD, NULL, NULL, 0, VIF_fr3X },
	{ "JOINFLOOD_TIME",0,		INT_TYPE_VAR,	DEFAULT_JOINFLOOD_TIME, NULL, NULL, 0, VIF_fr3X },
	{ "JOIN_NEW_WINDOW",0,          BOOL_TYPE_VAR,  DEFAULT_JOIN_NEW_WINDOW, NULL, NULL, 0, VIF_fr3X },
	{ "JOIN_NEW_WINDOW_TYPE",0,     STR_TYPE_VAR,   0, NULL, NULL, 0, VIF_fr3X },
	{ "KICKFLOOD",0,		BOOL_TYPE_VAR,	DEFAULT_KICKFLOOD, NULL, NULL, 0, VIF_fr3X  },
	{ "KICKFLOOD_TIME",0,		INT_TYPE_VAR,	DEFAULT_KICKFLOOD_TIME, NULL, NULL, 0, VIF_fr3X  },
	{ "KICK_IF_BANNED",0,		BOOL_TYPE_VAR,  DEFAULT_KICK_IF_BANNED, NULL, NULL, 0, VIF_fr3X },
	{ "KICK_ON_DEOPFLOOD",0,	INT_TYPE_VAR,   DEFAULT_KICK_ON_DEOPFLOOD, NULL, NULL, 0, VIF_fr3X },
	{ "KICK_ON_JOINFLOOD",0,	INT_TYPE_VAR,	DEFAULT_KICK_ON_JOINFLOOD, NULL, NULL, 0, VIF_fr3X },
	{ "KICK_ON_KICKFLOOD",0,	INT_TYPE_VAR,   DEFAULT_KICK_ON_KICKFLOOD, NULL, NULL, 0, VIF_fr3X  },
	{ "KICK_ON_NICKFLOOD",0,	INT_TYPE_VAR,   DEFAULT_KICK_ON_NICKFLOOD, NULL, NULL, 0, VIF_fr3X  },
	{ "KICK_ON_PUBFLOOD",0,		INT_TYPE_VAR,   DEFAULT_KICK_ON_PUBFLOOD, NULL, NULL, 0, VIF_fr3X  },
	{ "KICK_OPS",0,			BOOL_TYPE_VAR,	DEFAULT_KICK_OPS, NULL, NULL, 0, VIF_fr3X  },
	{ "LAMEIDENT",0,		BOOL_TYPE_VAR,	DEFAULT_LAME_IDENT, NULL, NULL, 0, VIF_fr3X },
	{ "LAMELIST",0,			BOOL_TYPE_VAR,	DEFAULT_LAMELIST, NULL, NULL, 0, VIF_fr3X },
	{ "LASTLOG",0,			INT_TYPE_VAR,	DEFAULT_LASTLOG, NULL, set_lastlog_size, 0, 0 },
	{ "LASTLOG_ANSI",0,		BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "LASTLOG_LEVEL",0,		STR_TYPE_VAR,	0, NULL, set_lastlog_level, 0, 0 },
	{ "LLOOK",0,			BOOL_TYPE_VAR,	DEFAULT_LLOOK, NULL, NULL, 0, 0 },
	{ "LLOOK_DELAY",0,		INT_TYPE_VAR,	DEFAULT_LLOOK_DELAY, NULL, NULL, 0, VIF_fr3X  },
	...
	{ "MAIL",0,			INT_TYPE_VAR,	DEFAULT_MAIL, NULL, BX_update_all_status, 0, VIF_fr3X },

	{ "MANGLE_INBOUND",0,		STR_TYPE_VAR,	0, NULL, set_mangle_inbound, 0, VIF_fr3X },
	{ "MANGLE_LOGFILES",0,		STR_TYPE_VAR,	0, NULL, set_mangle_logfiles, 0, VIF_fr3X },
	{ "MANGLE_OPERLOG",0,		STR_TYPE_VAR,	0, NULL, set_mangle_operlog, 0, VIF_fr3X },
	{ "MANGLE_OUTBOUND",0,		STR_TYPE_VAR,	0, NULL, set_mangle_outbound, 0, VIF_fr3X },

	{ "MAX_DEOPS",0,		INT_TYPE_VAR,	DEFAULT_MAX_DEOPS, NULL, NULL, 0, VIF_fr3X  },
	{ "MAX_IDLEKICKS",0,		INT_TYPE_VAR,	DEFAULT_MAX_IDLEKICKS, NULL, NULL, 0, VIF_fr3X  },
	{ "MAX_SERVER_RECONNECT",0,	INT_TYPE_VAR,	DEFAULT_MAX_SERVER_RECONNECT, NULL, NULL, 0, VIF_fr3X },
	{ "MAX_URLS",0,			INT_TYPE_VAR,	DEFAULT_MAX_URLS, NULL, NULL, 0, VIF_fr3X },
#ifdef GUI
	{ "MDI",0,				BOOL_TYPE_VAR,	DEFAULT_MDI, NULL, gui_mdi, 0, VIF_fr3X },
#else
	{ "MDI",0,				BOOL_TYPE_VAR,	DEFAULT_MDI, NULL, NULL, 0, VIF_fr3X },
#endif
	{ "META_STATES_VAR",0,		INT_TYPE_VAR,	DEFAULT_META_STATES, NULL, NULL, 0, 0 },
	{ "MIRCS",0,			BOOL_TYPE_VAR,  1, NULL, NULL, 0, VIF_fr3X  },
	...
	{ "MSGLOG_FILE",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X|VF_EXPAND_PATH },
	{ "MSGLOG_LEVEL",0,		STR_TYPE_VAR,	0, NULL, set_msglog_level, 0, VIF_fr3X},
	{ "NAMES_COLUMNS",0,		INT_TYPE_VAR,	5, NULL, NULL, 0, VIF_fr3X },
	{ "NAT_ADDRESS",0,		STR_TYPE_VAR,	0, NULL, set_nat_address, 0, VIF_fr3X },
	{ "ND_SPACE_MAX",0,		INT_TYPE_VAR,	DEFAULT_ND_SPACE_MAX, NULL, NULL, 0, 0 },
	{ "NEW_SERVER_LASTLOG_LEVEL",0,	STR_TYPE_VAR,	0, NULL, set_new_server_lastlog_level, 0, VIF_fr3X },
	{ "NEXT_SERVER_ON_LOCAL_KILL",0,  BOOL_TYPE_VAR,  0, NULL, NULL, 0, VIF_fr3X },

	{ "NICKFLOOD",0,		BOOL_TYPE_VAR,	DEFAULT_NICKFLOOD, NULL, NULL, 0, VIF_fr3X  },
	{ "NICKFLOOD_TIME",0,		INT_TYPE_VAR,	DEFAULT_NICKFLOOD_TIME, NULL, NULL, 0, VIF_fr3X  },
	{ "NICKLIST",0,		        INT_TYPE_VAR,	DEFAULT_NICKLIST, NULL, NULL, 0, VIF_fr3X  },
	{ "NICKLIST_SORT",0,		        INT_TYPE_VAR,	DEFAULT_NICKLIST_SORT, NULL, NULL, 0, VIF_fr3X  },
	{ "NICK_COMPLETION",0,		BOOL_TYPE_VAR,	DEFAULT_NICK_COMPLETION, NULL, NULL, 0, VIF_fr3X  },
	{ "NICK_COMPLETION_CHAR",0,	CHAR_TYPE_VAR,  DEFAULT_NICK_COMPLETION_CHAR, NULL, NULL, 0, VIF_fr3X },
	{ "NICK_COMPLETION_LEN",0,	INT_TYPE_VAR,	DEFAULT_NICK_COMPLETION_LEN, NULL, NULL, 0, VIF_fr3X  },
	{ "NICK_COMPLETION_TYPE",0,	INT_TYPE_VAR,	DEFAULT_NICK_COMPLETION_TYPE, NULL, NULL, 0, VIF_fr3X  },
	{ "NOTIFY",0,			BOOL_TYPE_VAR,	DEFAULT_NOTIFY, NULL, NULL, 0, VIF_fr3X },
	{ "NOTIFY_HANDLER",0,		STR_TYPE_VAR, 	0, NULL, set_notify_handler, 0, 0 },
	{ "NOTIFY_INTERVAL",0,		INT_TYPE_VAR,   DEFAULT_NOTIFY_INTERVAL, NULL, NULL, 0, VIF_fr3X },
	...
	{ "NO_FAIL_DISCONNECT",0,	BOOL_TYPE_VAR,	DEFAULT_NO_FAIL_DISCONNECT, NULL, NULL, 0, VIF_fr3X },
	{ "NUM_BANMODES",0,		INT_TYPE_VAR,   DEFAULT_NUM_BANMODES, NULL, NULL, 0, VIF_fr3X },
	{ "NUM_KICKS",0,		INT_TYPE_VAR,   DEFAULT_NUM_KICKS, NULL, NULL, 0, VIF_fr3X },
	{ "NUM_KILLS",0,		INT_TYPE_VAR,	1, NULL, NULL, 0, VIF_fr3X },
	{ "NUM_OF_WHOWAS",0,		INT_TYPE_VAR,	DEFAULT_NUM_OF_WHOWAS, NULL, NULL, 0, VIF_fr3X },
	{ "NUM_OPMODES",0,		INT_TYPE_VAR,   DEFAULT_NUM_OPMODES, NULL, NULL, 0, VIF_fr3X },
	{ "OPER_MODES",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "ORIGNICK_TIME",0,		INT_TYPE_VAR,	5, NULL, NULL, 0, VIF_fr3X },
#ifdef WANT_OPERVIEW
	{ "OV",0,			BOOL_TYPE_VAR,  DEFAULT_OPER_VIEW, NULL, set_ov_mode, 0, VIF_fr3X },
#else
	{ "OV",0,			BOOL_TYPE_VAR,  0, NULL, NULL, 0, VIF_fr3X },
#endif
	{ "PAD_CHAR",0,			CHAR_TYPE_VAR,	DEFAULT_PAD_CHAR, NULL, NULL, 0, 0 },
	{ "PING_TYPE",0,		INT_TYPE_VAR,   DEFAULT_PING_TYPE, NULL, NULL, 0, VIF_fr3X  },
	{ "PROTECT_CHANNELS",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, 0 },
	{ "PUBFLOOD",0,			BOOL_TYPE_VAR,	DEFAULT_PUBFLOOD, NULL, NULL, 0, VIF_fr3X },
	{ "PUBFLOOD_TIME",0,		INT_TYPE_VAR,	DEFAULT_PUBFLOOD_TIME, NULL, NULL, 0, VIF_fr3X  },
	{ "QUERY_NEW_WINDOW",0,         BOOL_TYPE_VAR,  DEFAULT_QUERY_NEW_WINDOW, NULL, NULL, 0, VIF_fr3X },
	{ "QUERY_NEW_WINDOW_TYPE",0,    STR_TYPE_VAR,   0, NULL, NULL, 0, VIF_fr3X },
	{ "QUEUE_SENDS",0,		INT_TYPE_VAR,	DEFAULT_QUEUE_SENDS, NULL, NULL, 0, VIF_fr3X },
	{ "RANDOM_LOCAL_PORTS",0,	BOOL_TYPE_VAR,	DEFAULT_RANDOM_LOCAL_PORTS, NULL, NULL, 0, VIF_fr3X },
	{ "RANDOM_SOURCE",0,		INT_TYPE_VAR,	DEFAULT_RANDOM_SOURCE, NULL, NULL, 0, VIF_fr3X },
	{ "REALNAME",0,			STR_TYPE_VAR,	0, NULL, set_realname, 0, VF_NODAEMON },
	{ "REVERSE_STATUS",0,		BOOL_TYPE_VAR,	0, NULL, reinit_status, 0, 0 },
	{ "SAVEFILE",0,			STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X  },
	{ "SCREEN_OPTIONS",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VF_NODAEMON },
	{ "SCRIPT_HELP",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X  },
	...
	{ "SEND_AWAY_MSG",0,		BOOL_TYPE_VAR,	DEFAULT_SEND_AWAY_MSG, NULL, NULL, 0, VIF_fr3X },
	{ "SEND_CTCP_MSG",0,		BOOL_TYPE_VAR,	DEFAULT_SEND_CTCP_MSG, NULL, NULL, 0, VIF_fr3X },
	{ "SEND_IGNORE_MSG",0,		BOOL_TYPE_VAR,	DEFAULT_SEND_IGNORE_MSG, NULL, NULL, 0, VIF_fr3X },
	{ "SEND_OP_MSG",0,		BOOL_TYPE_VAR,	DEFAULT_SEND_OP_MSG, NULL, NULL, 0, VIF_fr3X },
	{ "SERVER_GROUPS",0,            BOOL_TYPE_VAR,  DEFAULT_SERVER_GROUPS, NULL, NULL, 0, VIF_fr3X },
	...
	{ "SHITLIST",0,			BOOL_TYPE_VAR,  DEFAULT_SHITLIST, NULL, NULL, 0, VIF_fr3X  },
	{ "SHITLIST_REASON",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X  },
	{ "SHOW_AWAY_ONCE",0,		BOOL_TYPE_VAR,	DEFAULT_SHOW_AWAY_ONCE, NULL, NULL, 0, VIF_fr3X },
	...
	{ "SOCKS_HOST",0,		STR_TYPE_VAR,	0, NULL, set_use_socks, 0, VIF_fr3X },
	{ "SOCKS_PORT",0,		INT_TYPE_VAR,	DEFAULT_SOCKS_PORT, NULL, NULL, 0, VIF_fr3X },
...
#ifdef WANT_OPERVIEW
	{ "SWATCH",0,			STR_TYPE_VAR,	0, NULL, convert_swatch, 0, VIF_fr3X },
#else
	...
	{ "TIMESTAMP",0,		BOOL_TYPE_VAR,	DEFAULT_TIMESTAMP, NULL, NULL, 0, VIF_fr3X },
	{ "TIMESTAMP_AWAYLOG_HOURLY",0,	BOOL_TYPE_VAR,	DEFAULT_TIMESTAMP_AWAYLOG_HOURLY, NULL, NULL, 0, VIF_fr3X },
	{ "TIMESTAMP_STRING",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	...
	{ "USERLIST",0,			BOOL_TYPE_VAR,  DEFAULT_USERLIST, NULL, NULL, 0, VIF_fr3X },
	{ "USERMODE",0,			STR_TYPE_VAR,	0, NULL, set_user_mode, 0, VIF_fr3X},
	{ "USER_FLAG_OPS",0, 		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "USER_FLAG_PROT",0, 		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "USER_INFORMATION",0, 	STR_TYPE_VAR,	0, NULL, NULL, 0, 0 },
	{ "WINDOW_DESTROY_PART",0,      BOOL_TYPE_VAR,  DEFAULT_WINDOW_DESTROY_PART, NULL, NULL, 0, VIF_fr3X },
	{ "WINDOW_QUIET",0,		BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "WORD_BREAK",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "XTERM",0,			STR_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
	{ "XTERM_OPTIONS",0,		STR_TYPE_VAR,	0, NULL, NULL, 0, VF_NODAEMON },
	{ "XTERM_TITLE",0,		BOOL_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X }, 
	{ "_CDCC_CLOSE_IDLE_SENDS_TIME",0,INT_TYPE_VAR,	55,NULL, NULL, 0, VIF_fr3X },
	{ "_CDCC_MINSPEED_TIME",0,	INT_TYPE_VAR,	0, NULL, NULL, 0, VIF_fr3X },
...
/* def VAR_DEBUG*/
	...
	set_string_var(fr3X_HELP_VAR, DEFAULT_fr3X_HELP_FILE);
		...
		for (aptr = *aptrptr; aptr; prev = aptr, aptr = aptr->next)
		{
			switch(aptr->set->type)
			{
				...
				case STR_TYPE_VAR:
					...
					break;
				default:
					fr3say("Error in do_stack_set: unknown set type");
			}
		}
		return;
	}
...
void savefr3x_variables(FILE *fp)
{
	IrcVariable *var;
	int count = 0;
	for (var = irc_variable; var->name; var++)
	{
		if (!(var->flags & VIF_fr3X))
			continue;
		count++;
		fprintf(fp, "SET ");
		switch (var->type)
	...
	fr3say("Saved %d variables", count);
}
...
static	void exec_warning(Window *win, char *unused, int value)
{
	if (value == OFF)
	{
		fr3say("Warning!  You have turned EXEC_PROTECTION off");
		fr3say("Please read the /HELP SET EXEC_PROTECTION documentation");
	}
}
...
int old_window = window_display;
	...
	if (value)
		...
		fr3say("Auto Response is set to - %s", auto_str);
